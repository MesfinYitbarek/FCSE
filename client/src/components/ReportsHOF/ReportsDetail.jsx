            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-900">{report.generatedBy?.name || 'N/A'}</p>
                    <p className="text-sm text-gray-500">{report.generatedBy?.email || 'N/A'}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <dl className="space-y-3">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-sm text-gray-900">{report.generatedBy?.name || 'N/A'}</dd>
                  </div>
                  <div>
