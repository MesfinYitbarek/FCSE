                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-y-2 text-sm mb-3">
                        <div>
                          ...
                          <p className="font-medium text-gray-700 dark:text-gray-300">{course.department}</p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-700 dark:text-gray-300">L:{course.lecture} | Lab:{course.lab} | T:{course.tutorial}</p>
                        </div>
                      </div>
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                      {currentItems.map((course) => (
                        <tr key={course._id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm text-gray-900 dark:text-white">Year {course.year}</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">Sem {course.semester}</div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div className="flex justify-end space-x-3">
                              <button
                                onClick={() => openEditCourseModal(course)}
                                className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300 transition-colors flex items-center gap-1"
                              >
                                <Edit size={16} />
                                <span>Edit</span>
                              </button>
