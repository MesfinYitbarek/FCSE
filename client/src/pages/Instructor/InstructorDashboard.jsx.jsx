      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">{stats.assignments.total}</h3>
            </div>
          ...
          <div className="mt-4 space-y-3">
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="text-gray-600">{stats.assignments.completed} / {stats.assignments.total}</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="text-gray-600">{stats.assignments.pending} / {stats.assignments.total}</span>
              </div>
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link to="/assignmentsInst" className="flex flex-col items-center gap-2 p-3 bg-gray-50 hover:bg-indigo-50 rounded-lg transition-colors group">
              ...
              <span className="text-sm font-medium text-gray-700 group-hover:text-indigo-700">Assignments</span>
            </Link>

            <Link to="/preferencesInst" className="flex flex-col items-center gap-2 p-3 bg-gray-50 hover:bg-purple-50 rounded-lg transition-colors group">
            ...
            <Link to="/complaintsInst" className="flex flex-col items-center gap-2 p-3 bg-gray-50 hover:bg-amber-50 rounded-lg transition-colors group">
              ...
              <span className="text-sm font-medium text-gray-700 group-hover:text-amber-700">Complaints</span>
            </Link>

            <Link to="/reportsInst" className="flex flex-col items-center gap-2 p-3 bg-gray-50 hover:bg-green-50 rounded-lg transition-colors group">
