...
const ComplaintsCOC = () => {
  ...
  const [filters, setFilters] = useState(() => {
    const savedFilters = localStorage.getItem('complaintCOCFilters');
    if (savedFilters) {
  ...
  useEffect(() => {
    localStorage.setItem('complaintCOCFilters', JSON.stringify(filters));
  }, [filters]);
  ...
  useEffect(() => {
    ...
    // Auto-fetch complaints if we have saved filters
  ...
  const resetFilters = () => {
    ...
    localStorage.setItem('complaintCOCFilters', JSON.stringify(newFilters));
  };
